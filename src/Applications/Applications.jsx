...
function Applications() {
  ...
  return (
    <div className="canvasContainer">
      <canvas ref={canvasref} id="page18"></canvas>
      <div id="page8">
        <h1>
          <AnimatedText
            style={{ fontSize: 60, fontWeight: 400, color: "#9500ff7d" }}
            title={"Real Estate"}
            desc={
              "Light SealThe Light Seal gently flexes to conform to your face,delivering a precise fit while blocking out stray light."
            }
          />
        </h1>
      </div>
      ...
      <div id="page13">
        <h1>
          <AnimatedText
            style={{ fontSize: 70, fontWeight: 400, color: "#9500ff7d" }}
            title={"Finance"}
            desc={
              "Head Band.The Head Band provides cushioning, breathability, and stretch. The Fit Dial lets you adjust Vision Pro precisely to your head."
            }
